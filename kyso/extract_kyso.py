...
RE_NEGATIVE = re.compile(
    r"何者.{0,10}(?:非(?!常)|為非|不是|不正確|有誤|錯誤|不符合|不屬於|不包括|不包含|不適當|不適用|不為(?!了|何)|無法)"
    r"|何項.{0,10}(?:不正確|有誤|錯誤|不符合|不為|不適用|不是|不包括|不包含|無法)"
    r"|何種.{0,10}(?:不正確|有誤|錯誤|不符合|不適用|不是|不包括|不包含|無法)"
    r"|何者.{0,6}[「\"](?:非|不)[」\"]"
    r"|下列.{0,20}(?:有誤|不正確|錯誤的|不符合|非正確|不是|不包括|不包含|不適用|無法)"
    r"|哪.{0,5}(?:不正確|有誤|錯誤)"
    r"|何者.{0,20}無關"
    r"|何項.{0,20}無關"
    r"|何種.{0,20}無關"
